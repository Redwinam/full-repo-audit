...
End with the artifact locations and, if unfinished, the exact continuation invocation/state directory. Do not include credentials, raw personal data or unnecessary source dumps.
